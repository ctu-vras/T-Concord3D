...
#SBATCH --gres=gpu:1
#SBATCH --mem=40G
#SBATCH --output=logs/run_train_T3_3_s20_%j.log     # file name for stdout/stderr
...
python tools/train_cylinder_asym.py --config_path 'config/semantickitti/semantickitti_T3_3_s20.yaml' 2>&1 \
